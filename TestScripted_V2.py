...
#
# (1) Specifically for the map entitled FindAndDefeatZergling2 (single player case). 
#
...
class TestScripted(utils.TestCase):
  ...
  def test_defeat_zerglings(self):
    ...
    with sc2_env.SC2Env(
        map_name="FindAndDefeatDrones", 
        players=[sc2_env.Agent(sc2_env.Race.terran)], 
        step_mul=self.step_mul,
        disable_fog=True, #False, #
      ...
      agent=scripted_agent1.FindAndDefeatZergling_4()       # the script for void_ray
